...
We were very happy to be shortlisted as one of the top ten entries! Although in the end we didn't win a prize, we gave a short presentation and received useful feedback on our work from the judging panel. This was a fun challenge and I want to thank Luigi for suggesting we collaborate on an entry and for all his hard work and ideas. We're hoping to spend more time expanding the analysis and incorporating the judging feedback into a second version, which will of course be posted here. Watch this space!
